...
La base de datos fue tomada de un repositorio público de referencia para práctica estadística y se cita formalmente en la sección de referencias con formato APA (7.\textsuperscript{a} edición).
...
\addtolength{\tabcolsep}{-2pt} % Ajuste fino de espacio entre columnas
\begin{tabularx}{\textwidth}{@{} *{4}{X} *{2}{l} *{3}{X} @{}}
\toprule
\textbf{Edad} & \textbf{IMC} & \textbf{Hijos} & \textbf{Fumador} & \textbf{Sexo} & \textbf{Región} & \textbf{Predicción} & \textbf{L. inf.} & \textbf{L. sup.} \\
\midrule
...
\toprule
\textbf{Variable} & \textbf{Media} & \textbf{DE}  & \textbf{Mínimo} & \textbf{Máximo} \\
\midrule
Edad      & 40.31 & 13.47     & 18.00   & 64.00 \\
IMC       & 31.39 & 4.78     & 20.23   & 41.33 \\
Número de hijos & 1.30  & 1.31     & 0       & 5 \\
Costo anual  & 14986.02 & 13819.74  & 1121.87 & 60021.40 \\
\bottomrule
\end{tabular}
\end{table}
...
N.º hijos & 0.141 & -0.078 & 1.000 & 0.016 \\
...
\begin{table}[H]
\centering
\small % Reduce un poco el tamaño de la letra para que quepa todo
\caption{Predicción puntual e intervalo de predicción.}
\setlength{\tabcolsep}{3pt} % Reduce el espacio entre columnas
\begin{tabularx}{\textwidth}{@{} cccc l l >{\RaggedLeft\arraybackslash}X >{\RaggedLeft\arraybackslash}X >{\RaggedLeft\arraybackslash}X @{}}
\toprule
\textbf{Edad} & \textbf{IMC} & \textbf{Hijos} & \textbf{Fum.} & \textbf{Sexo} & \textbf{Región} & \textbf{Predicción} & \textbf{Límite inferior} & \textbf{Límite superior} \\
\midrule
25 & 24 & 0 & No & Mujer & Noroeste & 2.93\(^{\dagger}\) & -11509.87\(^{\dagger}\) & 11515.74 \\
45 & 30 & 2 & Sí & Hombre & Sureste & 37078.18 & 25714.43 & 48441.93 \\
60 & 33 & 3 & No & Mujer & Noreste & 21023.48 & 9604.75 & 32442.21 \\
...
\section{Referencias}
\begin{itemize}
    \item stedy. (n.d.). \textit{Machine-Learning-with-R-datasets} [Data set]. GitHub. Retrieved May 10, 2026, from \url{https://github.com/stedy/Machine-Learning-with-R-datasets}
    \item Instituto Tecnológico Metropolitano. (2026). \textit{Guía de trabajo de campo: Estadística inferencial en Excel o RStudio} [Material de curso].
\end{itemize}
