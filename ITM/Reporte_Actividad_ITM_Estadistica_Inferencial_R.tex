...
\end{tabular}
\end{table}
\noindent{\footnotesize \(^*\) Valor transcrito del output del notebook. Su interpretación requiere cautela por la asimetría de \texttt{charges} y la ausencia de restricción de positividad en el modelo lineal.}
