...
\midrule
25 & 24 & 0 & no  & female & northwest & 2.93\(^{\dagger}\)    & -11509.87\(^{\dagger}\) & 11515.74 \\
45 & 30 & 2 & yes & male   & southeast & 37078.18 & 25714.43  & 48441.93 \\
60 & 33 & 3 & no  & female & northeast & 21023.48 & 9604.75   & 32442.21 \\
\bottomrule
\end{tabular}
\end{table}
\noindent{\footnotesize \(^{\dagger}\) Valor transcrito del output del notebook. Su interpretación requiere cautela por la asimetría de \texttt{charges} y la ausencia de restricción de positividad en el modelo lineal. En la práctica, debe leerse como \emph{costo esperado muy bajo} (cercano a cero), no como un valor monetario literal utilizable para presupuestación puntual.}
