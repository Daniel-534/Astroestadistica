...
\begin{tabular}{lrrrr}
\toprule
\textbf{Variable} & \textbf{Edad} & \textbf{IMC} & \textbf{Hijos} & \textbf{Costo anual} \\
\midrule
...
\toprule
\textbf{Edad} & \textbf{IMC} & \textbf{Hijos} & \textbf{Fumador} & \textbf{Sexo} & \textbf{Región} & \textbf{Predicción} & \textbf{LI} & \textbf{LS} \\
\midrule
...
\section{Referencias}
\begin{itemize}
    \item Smola, A. (s.\,f.). \textit{Machine-Learning-with-R-datasets} [Conjunto de datos \texttt{insurance.csv}]. GitHub. \url{https://github.com/stedy/Machine-Learning-with-R-datasets}. Recuperado el 10 de mayo de 2026.
