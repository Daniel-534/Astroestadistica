...
$$\text{P-value} = 2 \cdot \sum_{x=0}^{37} \binom{100}{x}(0.5)^{100}\approx 0.012033$$

Aquí se hizo el cálculo: %% https://www.wolframalpha.com/input?i=2+*+Sum%5BBinomial%5B100%2C+x%5D+*+%280.5%29%5E100%2C+%7Bx%2C+0%2C+37%7D%5D
...
\subsection*{Ie): Conclusión con $x = 37$}

Del inciso (d), sabemos que:

$\bullet$ Región de rechazo: $X < 39$ o $X > 61$

$\bullet$ Región de no rechazo: $39 \leq X \leq 61$
