...
Para una distribución Binomial$(100, 0.5)$, buscamos los valores $x$ tales que:
$$2 \cdot P(X \leq x | p=0.5) = 0.056$$

Consultando tablas de la distribución binomial acumulada:
$$P(X \leq 38 | p=0.5) \approx 0.0280$$

Esto significa que $2 \times 0.0280 = 0.056$. Por lo tanto, rechazamos $H_0$ cuando $X \leq 38$ o $X \geq 62$.

Por simetría, el límite superior es $100 - 38 = 62$.

\textbf{Región de no rechazo:} $39 \leq X \leq 61$ (o equivalentemente, rechazamos si $X \leq 38$ o $X \geq 62$)
...
\textbf{Tabla Resumen de Potencia del Contraste:}
...
$\bullet$ Región de rechazo: $X \leq 38$ o $X \geq 62$

$\bullet$ Región de no rechazo: $39 \leq X \leq 61$

Dado que $x = 37$:
$$37 \leq 38 \text{ (está en la región de rechazo)}$$

Por lo tanto, \textbf{rechazamos $H_0$} al nivel de significancia de aproximadamente 0.056.
