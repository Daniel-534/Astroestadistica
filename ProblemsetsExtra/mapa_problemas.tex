...
\filaaplicacion{sec:problema-05}{Taxonomía de asteroides}{Eventos compuestos; complementos; independencia; probabilidades empíricas.}{4}
...
\filaaplicacion{sec:problema-12}{Modos de falla de un rover}{Unión de fallas; complemento; confiabilidad y simulación.}{3}
...
\filaaplicacion{sec:problema-27}{Apuntamiento de telescopio espacial}{Permutaciones sin repetición; restricciones térmicas; conteo complementario.}{6}
...
\filateorica{sec:problema-07}{Probabilidad del evento nulo}{Axiomas de probabilidad; exclusión mutua; aditividad numerable; demostración.}{4}
...
\filacomputacional{sec:problema-03}{Seguimiento de cometas}{Simulación geométrica; histogramas; \texttt{matplotlib}.}{4}
\filacomputacional{sec:problema-04}{Coordenadas ecuatoriales}{Muestreo uniforme; dispersión 2D; estimación Monte Carlo.}{5}
\filacomputacional{sec:problema-05}{Taxonomía de asteroides}{Operaciones de conjuntos; muestreo ponderado; barras de frecuencia.}{4}
\filacomputacional{sec:problema-07}{Evento nulo y axiomas}{Verificación numérica; sumas parciales; visualización de convergencia.}{4}
\filacomputacional{sec:problema-11}{Señales gravitacionales}{Simulación categórica; frecuencias; validación de probabilidades.}{4}
\filacomputacional{sec:problema-12}{Fallas de rover}{Simulación de eventos; confiabilidad empírica; visualización.}{3}
\filacomputacional{sec:problema-14}{Pipeline de transitorios}{Simulación secuencial condicionada; validación de tasas.}{4}
\filacomputacional{sec:problema-15}{Confiabilidad de sonda}{Bernoulli independientes; conteo de fallas; Monte Carlo.}{6}
\filacomputacional{sec:problema-16}{Interferometría gravitacional}{Coincidencias raras; simulación; estimación de falsos positivos.}{6}
\filacomputacional{sec:problema-21}{Clasificación mineralógica}{Cálculo posterior; simulación categórica; comparación bayesiana.}{5}
\filacomputacional{sec:problema-23}{Órbitas de cometas}{Simulación de clasificación; matrices de confusión; Bayes.}{6}
...
\filacomputacional{sec:problema-26}{Telescopio robótico}{\texttt{permutations}; filtrado de adyacencias; simulación.}{6}
\filacomputacional{sec:problema-27}{Apuntamiento espacial}{Generación exhaustiva; restricciones; algoritmos de filtrado.}{6}
