...
\usepackage{tikz}
\usetikzlibrary{arrows.meta,babel,backgrounds,calc,decorations.markings,decorations.pathmorphing,fit,positioning,shadows.blur}
...
% Encabezado académico compacto; el documento no utiliza portada.
\begin{center}
  {\Large\bfseries Universidad de Antioquia\par}
  \vspace{0.2cm}
  {\large Astroestadística\par}
  {\large\bfseries Problemset 1\par}
  \vspace{0.2cm}
  {\normalsize\textbf{Autor:} Daniel Soto Villada\par}
\end{center}
